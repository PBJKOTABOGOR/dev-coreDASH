...
(function(){
  ...
  const MODULE = 'perencanaan';
  const DATASET = '';
  const TITLE = 'Monitoring Perencanaan Cepat';
  const SUBTITLE = 'Pemantauan realisasi perencanaan dengan query backend agar data besar tetap cepat.';
  const COLUMNS = [{"label": "Kode RUP", "keys": ["kode_rup", "kd_rup"]}, {"label": "Nama Paket", "keys": ["nama_paket", "paket"]}, {"label": "Satuan Kerja", "keys": ["satuan_kerja", "satker"]}, {"label": "Pengadaan", "keys": ["pengadaan", "cara_pengadaan"]}, {"label": "Metode", "keys": ["metode_pengadaan", "metode"]}, {"label": "Pagu RUP", "keys": ["pagu_rup", "pagu"], "type": "money"}, {"label": "Realisasi", "keys": ["total_realisasi"], "type": "money"}, {"label": "Status", "keys": ["status", "warning"], "type": "badge"}];
  const SUMMARY_MAP = {"fastStat1": {"label": "Jumlah OPD", "keys": ["jumlahOpd", "instansi"]}, "fastStat2": {"label": "Total RUP", "keys": ["jumlahPaket", "totalRows"]}, "fastStat3": {"label": "Total Pagu", "keys": ["totalPagu"], "type": "money"}, "fastStat4": {"label": "Total Realisasi", "keys": ["totalRealisasi"], "type": "money"}};
