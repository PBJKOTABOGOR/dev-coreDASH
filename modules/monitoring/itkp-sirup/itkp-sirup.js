...
(function(){
  ...
  const MODULE = 'sirup';
  const DATASET = '';
  const TITLE = 'Monitoring SIRUP Cepat';
  const SUBTITLE = 'Summary, search, dan pagination diproses backend supaya data besar tetap ringan.';
  const COLUMNS = [{"label": "Kode RUP", "keys": ["kode_rup", "kd_rup"]}, {"label": "Nama Paket", "keys": ["nama_paket", "paket"]}, {"label": "Satuan Kerja", "keys": ["satuan_kerja", "satker", "nama_satuan_kerja"]}, {"label": "Metode", "keys": ["metode_pemilihan", "metode_pengadaan"]}, {"label": "Jenis", "keys": ["jenis_pengadaan"]}, {"label": "Sumber Dana", "keys": ["sumber_dana"]}, {"label": "Pagu", "keys": ["pagu_anggaran", "pagu", "nilai_pagu"], "type": "money"}, {"label": "Waktu", "keys": ["waktu_pemilihan"]}];
  const SUMMARY_MAP = {"fastStat1": {"label": "Jumlah OPD", "keys": ["jumlahOpd", "instansi"]}, "fastStat2": {"label": "Jumlah Paket", "keys": ["jumlahPaket", "totalRows"]}, "fastStat3": {"label": "Total Pagu", "keys": ["totalPagu"], "type": "money"}, "fastStat4": {"label": "Rata-rata ITKP", "keys": ["avgItkp"], "type": "decimal"}};
