...
(function(){
  ...
  const MODULE = 'nontender';
  const DATASET = '';
  const TITLE = 'Monitoring Non Tender Cepat';
  const SUBTITLE = 'Monitoring pencatatan Non Tender dengan backend cache dan pagination.';
  const COLUMNS = [{"label": "Kode RUP", "keys": ["kode_rup", "kd_rup"]}, {"label": "Nama Paket", "keys": ["nama_paket", "paket"]}, {"label": "OPD", "keys": ["satuan_kerja", "nama_perangkat_daerah", "opd"]}, {"label": "Metode", "keys": ["metode", "metode_pemilihan"]}, {"label": "Pagu", "keys": ["pagu", "nilai_pagu"], "type": "money"}, {"label": "Realisasi", "keys": ["total_realisasi", "realisasi_pencatatan"], "type": "money"}, {"label": "Status", "keys": ["status", "keterangan"], "type": "badge"}];
